...
"""Тестируем ссылки в шапке главной страницы. 32 теста."""
...
def test_winter_sale(web_browser):
    page = MainPage(web_browser)
...
"""Черный фон - Главное 2021"""


def test_header_main_2021(web_browser):
    page = MainPage(web_browser)
...
"""Серый фон - В соцсетях - Инстаграм"""
...
"""Серый фон - В соцсетях - Инстаграм.Дети"""
